...
// Crea una función que muestre en la consola el mensaje "El botón 
...
function preguntarCiudadBrasil() {
    let ciudad = prompt("¿Cual es el nombre de una ciudad de Brasil?");    
    alert("Estuve en " + ciudad + " y me acordé de ti");
}

// Crea una función que muestre una alerta con el mensaje: "Yo amo 
// JS" siempre que se presione el botón "Alerta".
function mostrarAlerta() {    
    alert("Yo amo JS");
}

// Al hacer clic en el botón "suma", pide 2 números y muestra el 
